...
| deploymentType | string | `"standalone"` | Deployment type. Allowed values: standalone or clustering </br> Ref: https://docs.opencti.io/latest/deployment/overview/ </br> Ref: https://docs.opencti.io/latest/deployment/clustering/ |
